...
class Runner:
    ...
    def train_with_gradient_descent(self, data, labels_data, normalized_feature_data, normalized_labels):
        ...
        #     x=range(1, len(self.neural_net_learner.cost_history) + 1),
        #     y=self.neural_net_learner.cost_history,
        #     x_label="Iteration",
        #     y_label="Training Cost",
        #     title="Training Learning Curve")
        #
        # cost = self.neural_net_learner.calculate_cost(predictions, normalized_labels)
